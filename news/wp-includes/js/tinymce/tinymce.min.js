...
!(function (V) {
	...
	var le,
		fe = {
			...
			contentEditable:
				!f ||
				g ||
				534 <= parseInt(se.match(/AppleWebKit\/(\d*)/)[1], 10),
			transparentSrc:
		...
		function (e) {
			...
			return s !== Me && 9 === s.nodeType && s.documentElement
				? ((ze = (Me = s).documentElement),
				  ...
				  (ke.getElementsByClassName = bt.test(
	...
	(St.attr = function (e, t) {
		...
		var n = _e.attrHandle[t.toLowerCase()],
			r =
				n && Ze.call(_e.attrHandle, t.toLowerCase())
					? n(e, t, !Ue)
					: undefined;
		return r !== undefined
			? r
				...
				contains: kt(function (t) {
					return (
						...
						function (e) {
							return (
								-1 <
								(e.textContent || e.innerText || Ae(e)).indexOf(
									t
								)
							);
						}
	...
	var En,
		...
		kr = function (e, t) {
			var n,
				...
				a =
					"" !== i ||
					((r = mr((n = e)) ? n.dom().parentNode : n.dom()) !==
						undefined &&
						null !== r &&
	...
	(kn = undefined),
		...
		(function (e) {
			...
			return (function i(a, u, s) {
				...
				for (
					var l = "function" == typeof Rn && Rn, e = 0;
					e < s.length;
					e++
				)
					c(s[e]);
						...
						function (s, e, c) {
							(function (e, t) {
								...
								(c.setTimeout = function () {
									...
									(u.prototype.unref = u.prototype.ref =
										function () {}),
		...
		var r = {},
			...
			j = {
				...
				createFragment: function (e) {
					...
					for (
						r.appendChild(n), e && (n.innerHTML = e);
						(t = n.firstChild);
	...
	var ea,
			...
			e.on("init", function () {
				e.serializer.addNodeFilter("span", function (e) {
					z(e, function (t) {
						var e;
						((e = t),
						_.from(e.attributes.map[ua()]).bind(n.lookup)).each(
							function (e) {
		...
		Ha = function (e) {
			return (
				!Va(e) &&
				(Ma(e) ? !za(e.parentNode) : Ua(e) || Fa(e) || ja(e) || qa(e))
			);
		},
		qa = function (e) {
			return (
				!1 ===
					((t = e),
					jo.isElement(t) &&
						"true" === t.getAttribute("unselectable")) && La(e)
			);
			var t;
		},
		$a = function (e, t) {
		...
		Ja = function (e, t) {
			return (
				e.top > t.bottom ||
				(!(e.bottom < t.top) && Ya(t.bottom - e.top, e, t))
			);
		},
		Qa = function (e, t, n) {
	...
	function Su(t, n, e) {
		...
		return {
			...
			toRange: function () {
				var e;
				return (
					(e = vu(t.ownerDocument)).setStart(t, n), e.setEnd(t, n), e
				);
			},
			getClientRects: r,
			isVisible: function () {
	...
	((ea = Su || (Su = {})).fromRangeStart = function (e) {
		...
		(ea.isAbove = function (e, t) {
			return ru(Z(t.getClientRects()), ee(e.getClientRects()), Ga).getOr(
				!1
			);
		}),
		(ea.isBelow = function (e, t) {
			return ru(ee(t.getClientRects()), Z(e.getClientRects()), Ja).getOr(
				!1
			);
		}),
	...
	var Tu,
		...
		Wu = function (e, t, n) {
			var r = n.getNode(),
				...
				i = n.getRng();
			if (Uu(r) || "IMG" === o)
				return { name: o, index: Vu(n.dom, o, r) };
			var a,
				u,
				s,
				c,
			...
			return {
				show: function (t, e) {
					...
					if (
						(l(),
						(o = e),
						jo.isElement(o) && /^(TD|TH)$/i.test(o.tagName))
					)
						return null;
					if (!u(e))
						return (
					...
					return (
						...
						c.get().each(function (e) {
							t &&
								gn(e.caret).addClass("mce-visual-caret-before");
						}),
						f(),
		...
		Os = function (e, t, n) {
			...
			if (((o = n.startContainer), (i = n.startOffset), Sa(o))) {
				if (
					...
					return Rs(r);
				if ("after" === a && ((r = o.previousSibling), gs(r)))
					return Ds(r);
			}
	...
	var Ms,
		...
		tc = function (e, t, n) {
			return e
				? !ec(t, n) &&
						((r = t),
						!(!_u.isTextPosition(r) && jo.isBr(r.getNode()))) &&
						Zs(t) &&
						Qs(n)
				: !ec(n, t) && Qs(t) && Zs(n);
			var r;
				...
				? Ha(u)
					? _.some(
							e
								? _u.before(u)
								: ((a = u),
								  jo.isBr(a) ? _u.before(a) : _u.after(a))
					  )
					: ((r = t),
					  (o = u),
		...
		Oc = function (t, e, n, r) {
			...
			if (
				(o && e[0].wrapper && (o = Ec(i, o, "ul,ol").reverse()[0] || o),
				!o)
			)
				for (
					o = n;
					...
					(o.collapsed &&
						((r = Pc(
							...
							3 === (n = t).startContainer.nodeType &&
								n.startContainer.nodeValue.length >=
									n.startOffset &&
								"\xa0" ===
									n.startContainer.nodeValue[n.startOffset]
						)),
	...
	var ul,
		...
		fl = function (e, t) {
			...
			o.collapsed &&
				((n = i),
				(r = a),
				jo.isText(n) && "\xa0" === n.nodeValue[r - 1]) &&
				jo.isText(i) &&
				(i.insertData(a - 1, " "),
				i.deleteData(a, 1),
				o.setStart(i, a),
		...
		dl = function (e, t, n) {
			...
			if (
				...
				if (
					((u = r.parse(t, k)),
					!0 === n.paste && Gc(e.schema, u) && Qc(p, i))
				)
					return (
				...
				if (
					(e._selectionOverrides.showBlockCaretContainer(i),
					k.invalid)
				) {
					for (
						fl(e, d),
		...
		Wl = function (e, t) {
			var n,
				...
				a = ar.fromDom(t);
			return (
				(n = a), (r = "pre,code"), (o = d(Mr, i)), ra(n, r, o).isSome()
			);
		},
		Kl = function (e, t) {
			return (
		...
		ff = function (e, t, n) {
			if (Jl(n))
				return Ui(n), Jl(t) && nl(t), sc.firstPositionIn(t.dom());
					...
					_o(ar.fromDom(a)) || So(ar.fromDom(a))
						...
						: ((t = u),
						  ...
						  Bs(!(n = s), (r = c)).fold(function () {
								...
								? Vf(u, s, c, e)
								: !1 === s &&
								  jo.isContentEditableFalse(e.getNode(!0))
								? Vf(u, s, c, e)
								: s && Ff(c)
				...
				jo.isElement(a) && a.getAttribute("data-mce-caret") === u
					? ((t = e),
					  ...
					  t && jo.isContentEditableFalse(n.nextSibling)
							...
							: !1 === t &&
							  jo.isContentEditableFalse(n.previousSibling)
		...
		Yf = function (e) {
			return Ha(e.nextSibling)
				? _.some(
						((t = e.nextSibling),
						jo.isText(t) ? _u(t, 0) : _u.before(t))
				  )
				: e.nextSibling
		...
		Qf = function (e, t, n) {
			return ((r = e), (o = t), (i = n), r ? Jf(o, i) : Gf(o, i)).map(
				d(Kf, n)
			);
			var r, o, i;
		},
		...
		rd = function (t, n, e, r) {
			...
			var o,
				...
				s = nd(
					e,
					a,
					((i = e), br(t.schema.getTextInlineElements(), lr(i)))
				);
		...
		ud = function (e) {
			var t,
				n = (function (e, t) {
					for (; t && t !== e; ) {
						if (
							jo.isContentEditableTrue(t) ||
							jo.isContentEditableFalse(t)
						)
							return t;
						t = t.parentNode;
					}
			...
			return e
				? (function (e) {
						if (sd(e.previousSibling))
							return (
								ld(e.previousSibling) ||
									e.previousSibling.appendData(xa),
								e.previousSibling
							);
						...
						qd(a) &&
							...
							(function (e, t) {
								if (
									...
									_u.isTextPosition(n) &&
										...
										(Hd(
											e,
											ss.removeAndReposition(t.get(), n)
										),
										t.set(null));
								}
							})(a, u),
							(function (n, r, o, e) {
								if (r.selection.isCollapsed()) {
									var t = U(e, n);
									z(t, function (e) {
										var t = _u.fromRangeStart(
											r.selection.getRng()
										);
										Ld(n, r.getBody(), t).bind(function (
											e
										) {
											return Wd(r, o, e);
										});
		...
		Gd = function (r, o, i, a) {
			...
			r.undoManager.ignore(function () {
				...
				r.selection.setRng(
					((e = i),
					(t = a),
					(n = V.document.createRange()).setStart(
						e.container(),
						e.offset()
					),
					n.setEnd(t.container(), t.offset()),
								...
								.map(function (e) {
									return (
										...
										!!ru(
											...
											sc.lastPositionIn(o),
											function (e, t) {
												var n = Vl.normalizePosition(
														!0,
														e
													),
													r = Vl.normalizePosition(
														!1,
														t
													);
												return sc
				...
				return Jl(e)
					...
					: ((t = a),
					  ...
					  sc.navigate(r, t.getBody(), i).bind(function (e) {
							return Sm(n, ar.fromDom(e.getNode())).map(function (
								e
							) {
								return !1 === Mr(e, o);
							});
					...
					for (a in c)
						if (c.hasOwnProperty(a)) {
							...
							if (
								...
								!Om(
									u,
									wc.normalizeStyleValue(
										e,
										wc.replaceVars(c[a], i),
										a
									)
								)
							)
				...
				t === r && jo.isText(t)
					...
					: (jo.isText(t) &&
					  ...
					  jo.isText(r) &&
							0 < o &&
							o < r.nodeValue.length &&
							(o = (r = zm(r, o).previousSibling).nodeValue
								.length)),
				{
					startContainer: t,
					startOffset: n,
		...
		gg = function (e, t) {
			return (function (e, t) {
				...
				var f = u(l);
				return (
					!!(f && s(f) && Fs(l, f)) && mg(e, n, c.getNode(), r, t, f)
				);
			})(e, t);
		},
		pg = function (e, t) {
		...
		cp = function (e) {
			return U(
				W(e.selection.getSelectedBlocks(), ar.fromDom),
				function (e) {
	...
	var yp,
		...
		Ap = function (e, t, n) {
			...
			Gi(e, t) && !1 === n
				? ((o = t),
				  $i((r = e)) ? r.dom().classList.remove(o) : Ki(r, o),
				  Yi(r))
				: n && Xi(e, t);
		},
		Rp = function (e, t) {
		...
		ph = function (e, t, n) {
			var r,
				...
				p = e.inline
					? g
					: ((r = g),
					  ar.fromDom(r.dom().ownerDocument.documentElement)),
				h =
					((o = e.inline),
					(a = t),
					(u = n),
			...
			l =
				...
				}),
				{
					create: function (e, t, n, r) {
						if (S(e))
							return o({ id: e, name: r, blob: t, base64: n });
						if (T(e)) return o(e);
					...
					removeByUri: function (t) {
						n = U(n, function (e) {
							return (
								e.blobUri() !== t ||
								(ae.revokeObjectURL(e.blobUri()), !1)
							);
						});
					},
					destroy: function () {
	...
	var iv = function (o, i, a, e, u, t) {
		...
		Ev = function (u, s) {
			return function (e) {
				if (0 === e.button) {
					var t = X(s.dom.getParents(e.target), au(xv, wv)).getOr(
						null
					);
		...
		return {
			parse: function (e) {
				...
				for (
					...
					if (
						(R < t.index && H(B(e.substr(R, t.index - R))),
						(n = t[6]))
					)
				...
				for (
					R < e.length && H(B(e.substr(R))), o = D.length - 1;
					0 <= o;
					o--
				)
					(n = D[o]).valid && $(n.name);
		...
		Zv = function (e) {
			var t = ar.fromTag(
				...
				Yv.get().getOrThunk(function () {
					var e =
						V.document.implementation.createHTMLDocument("undo");
		...
		yy = function (e, n, r, o, i) {
			...
			if (
				...
				!(
					...
					dy(l, f.block) ||
					(f.selector
						? jo.isElement(l) && c.is(l, f.selector)
						: void 0) ||
			...
			return "none" !== n.remove
				? ((d = e),
				  ...
				  (g.selector && g.inline && !dy(g.inline, m)) ||
						v.remove(m, 1),
				  !0)
				: void 0;
		},
				...
				i = function (e) {
					var n,
						...
						u =
							...
							(i = f),
							fy(
								wc.getParents(n.dom, t.parentNode).reverse(),
								function (e) {
									var t;
									a ||
										"_start" === e.id ||
						...
						fy(e, function (e) {
							g(e),
								jo.isElement(e) &&
									...
									e.parentNode &&
									"underline" ===
										wc.getTextDecoration(u, e.parentNode) &&
									yy(
										s,
										{
											deep: !1,
			...
			t.styles &&
				...
				Sy(
					...
					ky(
						e,
						"backgroundColor",
						wc.replaceVars(t.styles.backgroundColor, n)
					)
				);
		},
		By = function (e, t, n, r) {
						...
						Lc(s, e, function (e) {
							var a,
								u = function (e) {
									...
									if (y.wrapper && Mm.matchNode(g, e, p, h))
										a = 0;
									else {
										if (
											m &&
							...
							zy(r, function (t) {
								return a.formatter.matchNode(
									...
									? (u[n] ||
									  ...
									  (o[n] = e),
									  !1)
									: !Mm.matchesUnInheritedFormatSelector(
											a,
											t,
											n
									  ) && void 0;
				...
				addAttributeFilter: function (e, n) {
					hb(vb(e), function (e) {
						...
						for (t = 0; t < A.length; t++)
							if (A[t].name === e)
								return void A[t].callbacks.push(n);
	...
	var Tb,
		...
		Db = function (r, a) {
			...
			a.contentStyles.push(
				e +
					...
					e +
					" .mce-resize-helper {background: #555;background: rgba(0,0,0,0.75);border-radius: 3px;border: 1px;color: #D8D9DB;display: none;font-family: sans-serif;font-size: 12px;white-space: nowrap;line-height: 14px;margin: 5px 10px;padding: 5px;position: absolute;z-index: 10001}"
			);
			var R = function (e) {
					return (
						e &&
				...
				B = function (e) {
					...
					(t = e.screenX - d),
						...
						(t = A.scrollWidth - x) + (n = A.scrollHeight - w) !=
				...
				try {
					...
					r = (function (e, n, t) {
						...
						if (
							...
							0 <
								(i = (i = Xt.toArray(o.getClientRects())).sort(
									function (e, t) {
										return (
											(e = Math.abs(
												Math.max(
		...
		Jb = function (e, t) {
			...
			return 0 < o.length
				? Gb(e, o)
				: ((n = e),
				  0 < (r = t).length && r[0].collapsed ? Xb() : Yb(n, r[0]));
		},
		Qb = function (e, t) {
			if (
				(void 0 === t && (t = {}),
					...
					getSelectedBlocks: function (e, t) {
						return (function (e, t, n, r) {
							...
							if (
								((i = e.getRoot()),
								(n = e.getParent(
									n || tC(i, t, t.collapsed),
									e.isBlock
								)),
								(r = e.getParent(
									r || nC(i, t, t.collapsed),
									e.isBlock
								)),
								n && n !== i && a.push(n),
								n && r && n !== r)
	...
	var sC = function (e, t) {
		...
		cC = function (e, t, n, r) {
			for (
				...
				((s = l),
				(c = f),
				(o = t === Tu.Forwards ? s.next(c) : s.prev(c)));
		...
		CC = function (e, t, n, r) {
			...
			if (d) {
				...
				if ((u = pv(U(m, cv(1)), c)))
					return fg(t, u.position.toRange(), !0);
				if ((u = Ht.last(U(m, cv(0)))))
					return fg(t, u.position.toRange(), !0);
			}
		},
		xC = function (e, t, n) {
		...
		RC = function (e, t, n) {
			var r,
				...
				a,
				u = e(t, n);
			return ((a = u).breakType === Tb.Wrap &&
				0 === a.positions.length) ||
				(!jo.isBr(n.getNode()) &&
					(i = u).breakType === Tb.Br &&
		...
		PC = function (e, t) {
			var n = t.getNode(e);
			return jo.isElement(n) && "TABLE" === n.nodeName
				? _.some(n)
				: _.none();
		},
		IC = function (u, s, c) {
		...
		FC = function (t, n) {
			return function () {
				return _.from(t.dom.getParent(t.selection.getNode(), "td,th"))
					.bind(function (e) {
						return _.from(t.dom.getParent(e, "table")).map(
							function (e) {
								return BC(t, n, e);
							}
						);
		...
		MC = function (n, r) {
			return function () {
				return _.from(n.dom.getParent(n.selection.getNode(), "td,th"))
					.bind(function (t) {
						return _.from(n.dom.getParent(t, "table")).map(
							function (e) {
								return LC(n, r, e, t);
							}
						);
		...
		qC = function (t, n) {
			...
			(r = i),
			(o = d(Mr, r)),
			na(ar.fromDom(e.container()), Co, o).filter(zC)).exists(
				function () {
					if (HC(i, n, a)) {
						var e = VC(i, u, s, n);
		...
		Xx = function (e) {
			return Is(e)
				...
				.exists(function (e) {
					return (
						(t = kr(e, "white-space")), F(["pre", "pre-wrap"], t)
					);
					var t;
				});
		},
		...
		nw = function (t) {
			...
			t.selection.isCollapsed() &&
				tw(e, Su.fromRangeStart(t.selection.getRng())).each(function (
					e
				) {
					t.selection.setRng(e.toRange());
				});
		...
		bw = function (t, e) {
			...
			f.inline || (t.getElement().style.visibility = t.orgVisibility),
				...
				f.browser_spellcheck ||
					f.gecko_spellcheck ||
					((m.body.spellcheck = !1),
					vw.setAttrib(n, "spellcheck", "false")),
				(t.quirks = mw(t)),
				t.fire("PostRender"),
	...
	var Uw = function (e, t, n) {
		...
		tN = function (e, t, n) {
			...
			(r = l),
				...
				l.setDirty(!1),
				(l.plugins = {}),
				(l.documentBaseURI = new zw(t.document_base_url, {
					base_uri: d,
				})),
				(l.baseURI = d),
				(l.contentCSS = []),
	...
	var nN,
		...
		dN = function (e, t) {
			e.focusedEditor === t.editor && (e.focusedEditor = null),
				e.activeEditor ||
					(sN.unbind(V.document, "focusin", nN), (nN = null));
		},
		mN = function (e) {
		...
		(oN = {
			...
			setup: function () {
				...
				if (r) (e = r.base || r.baseURL), (n = r.suffix);
					...
					for (
						var o = V.document.getElementsByTagName("script"),
							i = 0;
						i < o.length;
						i++
					) {
					...
					!e &&
						...
						(-1 !==
							(a = V.document.currentScript.src).indexOf(
								".min"
							) && (n = ".min"),
						(e = a.substring(0, a.lastIndexOf("/"))));
				}
						...
						return (
							...
							A(r.get(n.id))
								...
								: (EN(n) &&
								  ...
								  0 === xN.length &&
										gN.unbind(window, "beforeunload", rN),
								  n.remove(),
								  NN(0 < xN.length),
								  n)
						);
			...
			execCommand: function (e, t, n) {
				...
				switch (e) {
					case "mceAddEditor":
						return (
							this.get(n) ||
								new tN(n, this.settings, this).render(),
							!0
						);
	...
	jN.extend = _N = function (n) {
		...
		n.Defaults &&
			o.Defaults &&
			(n.Defaults = UN({}, o.Defaults, n.Defaults)),
		n))
