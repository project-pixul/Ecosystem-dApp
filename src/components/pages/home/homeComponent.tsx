      ...
      <div className="container">
        <section className="intro">
          ...
          <div className="second-paragraph">
            ...
            <p>{t('home.paragraph3')} <a href={`https://etherscan.com/address/${TreasuryWalletAddress}`} target="_blank" rel="noreferrer" style={{ fontFamily: 'monospace', wordBreak: "break-word" }}>{TreasuryWalletAddress}</a></p>
            <p>
              {t('home.paragraph4_1')}
              <AnimatedNumber
            ...
            <Fade>
              <div>
                ...
                <div className="social-medias text-center text-lg-left">
                  <a href="#" rel="noreferrer" className="btn-social" target="_blank">
