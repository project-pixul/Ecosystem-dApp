...
class LaunchComponent extends BaseComponent<
	LaunchProps & WithTranslation,
	LaunchState
> {
			...
			<div className='col-md-3'>
				<a className='gradient-card dark shadow d-block'>
					...
					<div className='upcoming-launch-body'>
						<h4>
							1 {t('launch.eth')} = {presaleRate} {tokenName}
						</h4>
						<div>
							<h2>
								{amountRaised}/{hardCap} {t('launch.eth')}
							</h2>
						...
						<div className='d-flex justify-content-between'>
							...
							<p>
								{softCap} {t('launch.eth')}
							</p>
						</div>
						<div className='d-flex justify-content-between'>
							<p>{t('launch.min_cont')}:</p>
							<p>
								{minContribution} {t('launch.eth')}
							</p>
						</div>
						<div className='d-flex justify-content-between'>
							<p>{t('launch.max_cont')}:</p>
							<p>
								{maxContribution} {t('launch.eth')}
							</p>
						</div>
						<div className='d-flex justify-content-between'>
						...
						<div className='d-flex justify-content-center'>
							<Countdown date={Date.now() + timeUntilPresale} />
						</div>
					</div>
				</a>
			</div>
		...
		return (
			<div className='launch-container'>
				<div className='row text-white launch-header'>
					...
					<div>
						<button onClick={this.openModal} className='btn btn-golden'>
							Launch your project
						</button>
					</div>
				</div>
					...
					<div className='launch-modal'>
						...
						<form>
								...
								<div className='col-md-11'>
									<Collapsible
										...
										<div className='d-flex justify-content-end'>
											<button
												onClick={(e) => this.nextInput(e)}
												className='btn btn-small btn-complementary'>
												Next
											</button>
										</div>
									</Collapsible>
							...
							<div className='d-flex'>
								...
								<div className='col-md-11'>
									<Collapsible
										...
										transitionTime={240}>
										<p>
											Enter your presale price: (Number of tokens per 1 BNB)
										</p>
										<input placeholder='Ex. 200' />
										<div className='d-flex justify-content-end'>
											<button
												onClick={(e) => this.previousInput(e)}
							...
							<div className='d-flex'>
								...
								<div className='col-md-11'>
									<Collapsible
										...
										transitionTime={240}>
										<p>
											Enter the presale caps. Soft cap must be greater than, or
											equal to 50% of hard cap.
										</p>
										<p>Soft Cap:</p>
							...
							<div className='d-flex'>
								...
								<div className='col-md-11'>
									<Collapsible
										...
										transitionTime={240}>
										<p>
											Enter the minimum and maximum amounts purchasable by one
											wallet.
										</p>
										<p>Minimum:</p>
							...
							<div className='d-flex'>
								...
								<div className='col-md-11'>
									<Collapsible
										...
										transitionTime={240}>
										<p>
											Enter the percentage of raised funds to be allocated to
											the liquidity on PixulSwap: (Minimum of 51%)
										</p>
							...
							<div className='d-flex'>
								...
								<div className='col-md-11'>
									<Collapsible
										trigger='PixulSwap Rate'
										open={this.state.openedInput == 5}
										onTriggerOpening={() => this.collapseOtherDivs(5)}
										transitionTime={240}>
										<p>
											Enter the PixulSwap listing price: (Number of tokens per 1
											BNB)
										</p>
										<input placeholder='Ex. 100' />
										<div className='d-flex justify-content-end'>
							...
							<div className='d-flex'>
								...
								<div className='col-md-11'>
									<Collapsible
										...
										transitionTime={240}>
										<p>
											Logo URL: (Must end supported image format, e.g. png,
											jpeg, jpg. PNG preferred.)
										</p>
										<input placeholder='Ex. https://raptr.finance/pixul-logo.png' />
										<p>Project Description:</p>
										<input placeholder='Ex. Pixul Protocol is a decentralized...' />
										<div className='d-flex justify-content-end'>
											<button
												onClick={(e) => this.previousInput(e)}
												className='btn btn-small btn-dark'>
							...
							<div className='d-flex'>
								...
								<div className='col-md-11'>
									<Collapsible
										...
										<p>Telegram Link:</p>
										<input placeholder='Ex. https://t.me/PhilosoPixulToken' />
										<div className='d-flex justify-content-end'>
											<button
												onClick={(e) => this.previousInput(e)}
												className='btn btn-small btn-dark'>
									...
									<Collapsible
										...
										<div className='d-flex justify-content-between'>
											<div className='d-flex align-items-center'>
												...
												/>
												<label>
													I have confirmed that the information above is correct
												</label>
											</div>
											<div className='d-flex justify-content-end'>
												<button
