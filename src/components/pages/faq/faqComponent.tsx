      ...
      <div className="d-flex flex-row container">
        <div>
          <Fade bottom>
            ...
            <p><Trans i18nKey='faq.faq1.desc'>Pixul is launched on the Binance Smart Chain. This means that in order to buy Pixul, you need the
              ...
              your wallet and <a target="_blank"
                ...
                over to PancakeSwap</a>to buy Pixul for BNB. Make sure you set your slippage to 8%.</Trans><br /></p>
          </Fade>
          <Fade bottom>
            ...
            <p><Trans i18nKey="faq.faq2.desc">Go to <a href="staking">our &quot;Staking&quot; page</a>. It will automatically ask you to connect
              your wallet, connect the wallet that contains your Pixul Tokens. You will see your wallet information appear and the total amount of Pixul Tokens that you own in your wallet. We do not charge any fees for staking but you have to have BNB in your wallet in order to pay for the Binance SmartChain gas fees. Make sure you keep enough BNB in your wallet to claim or unstake you Pixul Tokens in the future. When you are all set use the slidebar to select how many Pixul Tokens you wish to stake. Press the &quot;Stake&quot; button to stake the amount of Pixul tokens you entered. Now your Pixul Tokens are staked and you'll earn 5% APY.</Trans></p>
          </Fade>
          <Fade bottom>
            <h1><span>{t('faq.faq3.title')}<br /></span></h1>
            <p><Trans i18nKey='faq.faq3.desc'>When you have staked your Pixul Tokens you're able to claim your rewards anytime you wish. Just press the &quot;Claim&quot; button
          ...
          <Fade bottom>
            ...
            <p><Trans i18nKey='faq.faq4.desc'>Go to <a href="staking">our &quot;Staking&quot; page</a> and press the &quot;Unstake&quot; button. All of your staked
              Pixul Tokens and your rewards will be automatically transferred to your wallet.
          ...
          <Fade bottom>
            ...
            <p><Trans i18nKey='faq.faq5.desc'>Yes, <a href="https://bscscan.com/tx/0xf5ec7ea50fffba3e1c2ab21f9bd3a7e29d11791b523f6af36ebd1bb5e145ec6c"
              target="_blank">we have locked the liquidity</a> until the release of PixulSwap. At which point,
