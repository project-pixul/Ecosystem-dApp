...
import { PixulLottery } from '../contracts/busdlottery';
...
import './busdLotteryComponent.css';

export type LotteryProps = {}
export type LotteryState = {
    lottery?: PixulLottery,
    wallet?: Wallet,
    looping?: boolean,
...
class LotteryComponent extends BaseComponent<LotteryProps & WithTranslation, LotteryState> {
    ...
    async componentDidMount() {
        ...
        // 	const lottery = new PixulLottery(wallet);
            ...
            <div className="container">
                <div className="row text-white lottery-header">
                    <div className="col-md-12">
                        ...
                        <p><Trans i18nKey='lottery.paragraph2'>In order to stake Pixul tokens, you need to connect your browser wallet (such as <a
                    ...
                    <FadeInLeftDiv className="col-md-6 d-flex">
                        <div className="shadow d-flex flex-column flex-fill gradient-card primary">
                            ...
                            <AnimatedNumber
                                ...
                                duration="1000"
                                formatValue={value => `${Number(parseFloat(value).toFixed(2)).toLocaleString('en', { minimumFractionDigits: 2 })} Pixul Tokens`}
                                className="lottery-info"
                            >
                                {numeral(state.price || 0).format('0,0.00')} Pixul Tokens
                            </AnimatedNumber>
                        </div>
                    </FadeInLeftDiv>
                    <FadeInRightDiv className="col-md-6 d-flex">
                        <div className="shadow d-flex flex-column flex-fill gradient-card light">
                            ...
                            <AnimatedNumber
                                ...
                                className="lottery-info"
                            >
                                {numeral(state.jackpot || 0).format('0,0.00')} Pixul Tokens
                            </AnimatedNumber>
