...
class StakingComponent extends BaseComponent<StakingProps & WithTranslation, StakingState> {
	...
	async connectWallet() {
		try {
			...
			this.updateState({ pixul: pixul, wallet: wallet, looping: true, pending: false });
			this.updateOnce(true).then();
	...
	async disconnectWallet() {
		try {
			...
			this.updateState({ pixul: null, wallet: null, address: null, looping: false, pending: false });
		}
		catch (e) {
			this.updateState({ pending: false });
			this.handleError(e);
			...
			<div className="container">
				<div className="row text-white staking-header">
					<div className="col-md-12">
						...
						<p><Trans i18nKey='staking.paragraph2'>In order to stake xPixul tokens, you need to connect your browser wallet (such as <a
